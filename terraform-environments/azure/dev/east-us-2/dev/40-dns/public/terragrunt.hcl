...
terraform {
  source = "git::ssh://git@github.com/ManagedKube/kubernetes-ops.git//terraform-modules/azure/dns/public?ref=v2.0.85"
}
...
# ---------------------------------------------------------------------------------------------------------------------
inputs = {
  name = "${local.env_common_vars.locals.environment_name}.azure.${local.environment_vars.locals.root_domain_name}"
