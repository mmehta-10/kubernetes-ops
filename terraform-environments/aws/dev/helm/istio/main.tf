locals {
  ...
  tags = {
    ...
    ops_source_repo_path = "terraform-environments/aws/${local.environment_name}/helm/istio",
    ops_owners           = "devops",
  }
}
...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "kubernetes-ops-dev-helm-istio"
    }
  }
}
...
#
module "istio" {
  source = "github.com/ManagedKube/kubernetes-ops//terraform-modules/aws/istio?ref=v2.0.85"
